...
const SelectedMovie = () => {
  ...
  const handleClickdate = (data: any) => {
    console.log('handleClickdate called', data);
    setDate(data);
    setWarn(true);
  ...
  const handleDateClickTime = (time: any, showTime: any) => {
    if (date) {
            ...
            <Box sx={{ paddingTop: '70px' }}>
              ...
              >
                ...
                {/* <TextField
                    id="standard-select-currency"
                    select
                    sx={{ marginLeft: '5px', display: {xs: 'none', lg: 'block'} }}
                    defaultValue="studio"
                    variant="standard"
                  >
